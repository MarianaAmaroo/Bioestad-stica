...
Calcular la probabilidad acumulada de que ocurran k o menos eventos

ppois(k, lambda)

Generar n valores aleatorios de una distribución de Poisson con parámetro lambda
...
barplot(prob, names.arg=k, xlab="Número de eventos", ylab="Probabilidad",
        main=paste("Distribución de Poisson (lambda =", lambda, ")"))
...
legend("topright", legend = k, fill = rainbow(length(k)), title = "Número de eventos")
